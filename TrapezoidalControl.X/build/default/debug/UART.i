...
void ConvertADC12BitToHexASCII_A() {
    ...
    ADPCH = channel_ANA7;
    PIE1bits.ADIE = 0;
    digitos[2] = conversion[ADRESL & 0x0F];
    digitos[1] = conversion[(ADRESL >> 4) & 0x0F];
...
void ConvertADC12BitToHexASCII_B() {
    ...
    ADPCH = channel_ANA6;
    PIE1bits.ADIE = 0;
    digitos[6] = conversion[ADRESL & 0x0F];
    digitos[5] = conversion[(ADRESL >> 4) & 0x0F];
...
void ConvertADC12BitToHexASCII_C() {
    ...
    ADPCH = channel_ANC0;
    PIE1bits.ADIE = 0;
    digitos[10] = conversion[ADRESL & 0x0F];
    digitos[9] = conversion[(ADRESL >> 4) & 0x0F];
...
void convertirASCII(void) {
        ...
        digitos[0 + i] = conversion[(send_data[i2] >> 8) & 0x000F];
        digitos[1 + i] = conversion[(send_data[i2] >> 4) & 0x000F];
        digitos[2 + i] = conversion[send_data[i2] & 0x000F];
        i+=4;
        i2++;
        if (i ==16) {
            i2 = 0;
