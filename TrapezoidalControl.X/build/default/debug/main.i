...
uint16_t ValorADC;
uint16_t preValorADC = 0;
_Bool cambioValorADC = 0;
_Bool canal_eleccion = 0;

char digitos[28];
volatile char* digito_ptr;
...
uint16_t velocidad;
_Bool cambioVelocidad = 0;
_Bool extern acelerando;
...
# 131 "main.c"
    ...
    while (1) {
        ...
        if (leidos[0] == 0x56 && cambioVelocidad) {
