...
# 1 "mcc_generated_files/cwg2.h" 1
# 94 "mcc_generated_files/cwg2.h"
void CWG2_Initialize(void);
# 122 "mcc_generated_files/cwg2.h"
void CWG2_AutoShutdownEventSet();
# 159 "mcc_generated_files/cwg2.h"
void CWG2_AutoShutdownEventClear();
# 64 "mcc_generated_files/mcc.h" 2

# 1 "mcc_generated_files/cwg3.h" 1
# 94 "mcc_generated_files/cwg3.h"
void CWG3_Initialize(void);
# 122 "mcc_generated_files/cwg3.h"
void CWG3_AutoShutdownEventSet();
# 159 "mcc_generated_files/cwg3.h"
...
# 1 "mcc_generated_files/../UART.h" 1
# 36 "mcc_generated_files/../UART.h"
...
# 1 "mcc_generated_files/../ADCMax.h" 1
# 49 "mcc_generated_files/../ADCMax.h"
...
# 1 "mcc_generated_files/../DirCW.h" 1
# 15 "mcc_generated_files/../DirCW.h"
void startUpForwardMode();
void forwardMode();
void state1F();
void state2F();
void state3F();
...
void state6F();
void deadTimeF();
# 53 "mcc_generated_files/interrupt_manager.c" 2

# 1 "mcc_generated_files/../DirCCW.h" 1
# 14 "mcc_generated_files/../DirCCW.h"
void startUpReverseMode();
void reverseMode();
void state1();
void state2();
void state3();
...
void state6();
void STOP();
# 54 "mcc_generated_files/interrupt_manager.c" 2

# 1 "mcc_generated_files/../Joystick.h" 1
# 26 "mcc_generated_files/../Joystick.h"
void actualizarDir();
...
_Bool extern prevHallA;
_Bool extern prevHallB;
_Bool extern prevHallC;
_Bool extern timer6;
_Bool extern ascii;
_Bool extern index;
_Bool extern enviado;
_Bool extern calcPromedio;
int extern contConm;
int extern i;
...
void __attribute__((picinterrupt(("")))) INTERRUPT_InterruptManager(void) {
    ...
    if (PIE4bits.TMR1IE == 1 && PIR4bits.TMR1IF == 1) {
        ...
        T1CONbits.TMR1ON = 0;
        measuring = 0;
        rps = (uint16_t) (pulse_count);
        send_data[0] = rps;
        T6PR = (int) (8354.35 / rps);
        pulse_count = 0;
        Temp();
