...
uint16_t highByte_16 = 0, lowByte_16 = 0;
uint16_t extern ValorADC;
uint16_t extern preValorADC;
_Bool extern cambioValorADC;
_Bool extern canal_eleccion;
void SPI_ADCext_completeValue() {

    SPI1_Close();
    Alternar_channel_ADC();
    do { LATAbits.LATA1 = 1; } while(0);
    do { LATAbits.LATA1 = 0; } while(0);
    SPI1_Open_config_adcMAX1666();
    PIE2bits.SPI1RXIE = 1;
    SPI1TCNTL = 0x02;
